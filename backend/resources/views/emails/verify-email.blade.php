...
<head>
   ...
   */
        ...
        .btn:hover {
            background-image: linear-gradient(45deg, #8399e8, #607de3);
        }
    </style>
</head>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <p style="margin: 0;">Welcome to {{ config('app.name') }}! Please verify your email address
                                to
                                get started.</p>
                        </td>
                    </tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td align="center" bgcolor="#e9ecef"
                            ...
                            <p style="margin: 0;">You received this email because we received a request to verify your
                                email address. If you didn't request this, you can safely delete this email.</p>
                        </td>
                    </tr>
                    <!-- end permission -->
